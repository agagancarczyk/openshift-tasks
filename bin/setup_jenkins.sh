...
oc new-build --name="jenkins-agent-appdev" -e GUID=${GUID} -e REPO="${REPO}" -e CLUSTER="${CLUSTER}" -D $'FROM docker.io/openshift/jenkins-agent-maven-35-centos7:v3.11\n 
             USER root\n 
